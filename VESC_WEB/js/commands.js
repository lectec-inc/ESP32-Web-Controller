...
export const COMMANDS = {
  ...
  export function parseCommandData(commandId, data) {
    ...
    switch (commandType) {
      ...
      case 'COMM_LISP_PRINT':
        console.log('Serializing COMM_LISP_PRINT command.');
        break;
 ...
 function parseCommLispPrint(data) {
    // Assuming `data` is text or UTF-8 encoded message content
    const message = new TextDecoder().decode(data.buffer);
    console.log("COMM_LISP_PRINT Message:", message);
    return { message };
} 
